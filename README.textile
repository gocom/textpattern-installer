...
p. Once there, you can start consuming theme and plugin packages with the normal composer commands such as @update@, @install@ and @require@. For instance installing and adding "rah_replace":http://rahforum.biz/plugins/rah_replace to your @composer.json@ doesn't take more than a single command:

bc. $ composer.phar require "rah/rah_replace *"

p. Which would install the most recent version of rah_replace. You can find more information about Composer and its commands by running @help@:
