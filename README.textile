...
p. *textpattern-plugin*
The package contains "manifest.json":https://github.com/gocom/abc_plugin formatted plugin sources.

p. *textpattern-plugin-package*
The package contains collection of compiled plugin installer packages. All found packages are installed.

p. *textpattern-admin-theme*
The package is an admin-side theme. Themes are installed to your ./textpattern/theme directory.

h3. Requirements and supports
