...
p. Include the installer in your composer.json by adding it as a dependency and change the type to @textpattern-plugin@, @textpattern-plugin-package@ or @textpattern-admin-theme@.
